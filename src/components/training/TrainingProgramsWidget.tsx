...
export default function TrainingProgramsWidget({
  ...
  const [programs, setPrograms] = useState<ProgramCard[] | null>(null);
  ...
  return (
    <div className="crossfade-container">
      ...
      {/* Content */}
      <div className={`crossfade-content ${!isLoading && programs ? "visible" : ""}`}>
        ...
        {programs && programs.length > 0 && (
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-6 stagger-fade-in">
